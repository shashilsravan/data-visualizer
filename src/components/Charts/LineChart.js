...
import LineCharGraph from '../GraphComponents/LineCharGraph';
...
export default function LineChart() {
    const [selectedFile, setSelectedFile] = useState(lineChartData)
    ...
    return (
        <div>
            <ChartHeader>
                <TimelineIcon color="primary" /> &nbsp; Line chart &nbsp;
            ...
            <GraphComponent>
                <LineCharGraph data={selectedFile} 
                    yVar={yVar} xVar={xVar} />
            </GraphComponent>}
