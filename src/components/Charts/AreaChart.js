...
import AreaChartGraph from '../GraphComponents/AreaChartGraph';
...
export default function AreaChart() {
    ...
    const [selectedFile, setSelectedFile] = useState(areaChartData)
    ...
    return (
        <div>
            <ChartHeader>
                <ShowChartIcon color="primary" /> &nbsp; Area chart &nbsp;
            ...
            <GraphComponent>
                <AreaChartGraph data={selectedFile} 
                    yVar={yVar} xVar={xVar} />
            </GraphComponent>}
