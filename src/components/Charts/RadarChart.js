...
import radarChartData from '../data/radarChart.json'
...
import RadarChartGraph from '../GraphComponents/RadarChartGraph';
...
export default function RadarChart() {
    const [selectedFile, setSelectedFile] = useState(radarChartData)
    ...
    return (
        <div>
            <ChartHeader>
                <TrackChangesIcon color="primary" /> &nbsp; Radar chart &nbsp;
                <TrackChangesIcon style={{color: "green"}} />
            </ChartHeader>
            ...
            <GraphComponent>
                <RadarChartGraph data={selectedFile} 
                    yVar={yVar} xVar={xVar} />
            </GraphComponent>}
